...
<div class="page-container">
	<div class="text-c">
		<form action="AdminServlet?action=findbookmessage" method="post">
	...
	<div class="mt-20">
		...
		<div style="text-align: center">
			 <div class="inline pull-right page">
						<a class="btn btn-secondary-outline  size-MINI radius" href='AdminServlet?action=bookList&currentPage=1' >首页</a>

						<a class="btn btn-secondary-outline  size-MINI radius"href='AdminServlet?action=bookList&currentPage=${pageTool.lastPage}'>上一页</a>

						<a class="btn btn-secondary-outline  size-MINI radius"href='AdminServlet?action=bookList&currentPage=${pageTool.nextPage}'>下一页</a>

						<a class="btn btn-secondary-outline  size-MINI radius" href='AdminServlet?action=bookList&currentPage=${pageTool.pageCount}'>尾页</a>
