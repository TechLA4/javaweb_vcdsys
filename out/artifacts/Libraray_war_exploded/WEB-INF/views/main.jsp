...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<c:if test="${type==1 }">
			...
			<dl >
				<%--<dt><i class="Hui-iconfont">&#xe62c;</i> &emsp;图书管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>--%>
				<dt>
					<ul>
						...
						<%--<li><a title="延迟还书" href="JytsServlet?action=toEditychsInfo&id=${jyts.id}" target="mainFrame">  &emsp;延迟还书</a></li>--%>
					</ul>
				</dt>
			</dl>
...
<%--管理员--%>
		<c:if test="${type==2 }">
			...
			<dl >
				<%--<dt><i class="Hui-iconfont">&#xe62c;</i> &emsp;后台管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>--%>
				<dt>
					<ul>

						<li><a title="管理用户" href="StudentServlet?action=list" target="mainFrame">  &emsp;管理用户</a></li>
