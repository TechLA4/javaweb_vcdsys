			...
			<c:forEach items="${list}" var="u" >
				...
				<td>${u.bookNo }</td>
					...
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" href="AdminServlet?action=updateHscz&id=${u.id}" onclick="Hui_admin_tab(this)"   title="还书" ><button  class="btn radius size-S btn-secondary" type="button">还书</button></a>
					</td>
				</tr>
