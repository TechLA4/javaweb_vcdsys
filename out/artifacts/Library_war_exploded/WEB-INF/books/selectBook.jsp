        ...
        <form class="layui-form" action="BookServlet?action=findByMap" method="post" style="width: 50%;padding-left: 39%;padding-top: 6%">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="bookNo" name="bookNo"   lay-verify="required" placeholder="请输入编号" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">书名</label>
                <div class="layui-input-block">
                    <input type="name" name="name"  lay-verify="required" placeholder="请输入书名" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">作者</label>
                <div class="layui-input-block">
                    <input type="text" name="auth"   lay-verify="required" placeholder="请输入作者" autocomplete="off" class="layui-input">
                </div>
            </div>
