...
<div class="page-container">
		...
		<form action="StudentServlet?action=update" method="post" class="form form-horizontal" >
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
					...
					用  户  名：</label>
				<div class="formControls col-xs-3 col-sm-3">
					<input type="text" class="input-text" value="${student.realname}" placeholder="请输入用户姓名" id="realname" name="realname">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
